...
- Shared visible labels: Review queue, Reply inbox, Outbox, Activity, Policy, Workspaces, Setup, Find a record, All channels, Highest priority, Why this follow-up, Recent activity, Draft message, AI draft · Editable, Reject, Skip, Approve to outbox.
