...
export function WorkspaceManager(props: Props) {
  ...
  return <div className="workspace-management">
    ...
    {!props.token ? <div className="empty-state"><h2>Engine access required</h2><p>Open Setup to unlock workspace settings.</p><button className="button primary" onClick={props.onSetup}>Open setup</button></div> : <>
